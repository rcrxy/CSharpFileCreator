...
public sealed class CSharpRoslynFormatter
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (CSharpFormattingException)
        {
            throw;
        }
        catch (Exception exception)when (exception is not OutOfMemoryException)
        {
            throw new CSharpFormattingException(
                CSharpFormattingErrorCode.FormattingFailure,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var formattingSpan = request.Kind switch
        {
            ...
            _ => throw new CSharpFormattingException(
                CSharpFormattingErrorCode.InvalidRequest,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new CSharpFormattingException(
                CSharpFormattingErrorCode.ParseFailure,
