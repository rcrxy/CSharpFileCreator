...
internal static class CSharpFormattingRequestValidator
{
    ...
    private static void ValidateSpan(string source, CSharpTextSpan span)
    {
        ...
        {
            throw new CSharpFormattingException(
                CSharpFormattingErrorCode.InvalidSpan,
    ...
    private static CSharpFormattingException InvalidRequest(string message)
    {
        return new CSharpFormattingException(CSharpFormattingErrorCode.InvalidRequest, message);
    }

    private static CSharpFormattingException InvalidConfiguration(string message)
    {
        return new CSharpFormattingException(CSharpFormattingErrorCode.InvalidConfiguration, message);
    }
}
